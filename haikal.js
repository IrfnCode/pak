...
› Create By IRFNCODE BOT
› Base Ori IRFNCODE BOT - Haikal

🌷 KALAU MAU RENAME TARO CREDITS GUA : IRFNCODE BOT*/
...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER IRFNCODE BOT`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/7b3c0ac03dab420c5c12b.jpg',"thumbnail": thumb,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m})} 
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yoapk IRFAN')
}
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yozip IRFAN')
}
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yopdf IRFAN')
}
...
haikal.sendMessage(from, anuala, `IRFNCODE BOT${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
caption: `© IRFNCODE BOT${buttonkal}`,
} 
...
title: `©️ IRFNCODE BOT`,
rows: [
{title: `🔏 PANEL IRFNCODE`, rowId: `${prefix}panel`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}, 
...
let teks = `${q}`
{
haikal.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER IRFNCODE BOT`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷 IRFNCODE BOT WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(bnnd, `🌷 IRFNCODE BOT WA 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
sticSukses(from)
break
//=================================================//
case 'sendtrol':{
...
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `IRFNCODE BOT${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone1}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone2}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone3}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone4}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone5}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${iphone6}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${buttonkal}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `IRFNCODE BOT${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `© IRFNCODE BOT${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME IRFNCODE BOT${ngazap(prefix)}`,
"groupName": `MY NAME IRFNCODE BOT${ngazap(prefix)}`,
